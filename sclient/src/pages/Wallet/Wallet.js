            ...
            <div className='cards wallet-card'>
              ...
              <div className='row'>
                ...
                <div className='col-lg-3 col-md-4 col-sm-5'>
                  <button className='thm-btn w-100' data-bs-toggle="modal" data-bs-target="#success">Recharge</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <button className='thm-btn w-100' data-bs-dismiss="modal" aria-label="Close">Ok</button>
            </div>
          </div>
        </div>
      </div>
